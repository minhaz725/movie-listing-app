...
public class UserServiceTest {
    ...
    public static final MovieModel movie1 = new MovieModel("Deadpool 3", "Hugh Jackman", "Action, Comedy, Sci-Fi", LocalDate.of(2024, 5, 3), 150000000);
    public static final MovieModel movie2 = new MovieModel("X-Men: Days of Future Past", "Hugh Jackman", "Action, Sci-Fi", LocalDate.of(2014, 5, 23), 200000000);
    public static final MovieModel movie3 = new MovieModel("Oppenheimer", "Cillian Murphy", "Drama, History", LocalDate.of(2023, 7, 21), 100000000);
    public static final MovieModel movie4 = new MovieModel("Exhuma", "Choi Min-sik", "Horror, Thriller, Drama", LocalDate.of(2024, 2, 22), 15000000);
